    ...
    return (
        <>
            ...
            <div
                ...
                aria-hidden="true"
            ></div>
            <aside className={`fixed inset-y-0 right-0 z-30 w-64 bg-white flex flex-col h-screen shadow-lg transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex-shrink-0 ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
